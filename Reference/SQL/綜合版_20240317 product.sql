...
VALUES 
  (1,NULL, NOW(), 'Test Ad 1', 'https://www.google.com/', NOW(), DATE('2099-12-31 00:00:00'), 0, 'This is a test ad.', "平台使用", NOW(), true),
  (2,NULL, NOW(), 'Test Ad 2', 'https://www.google.com/', NOW(), DATE('2099-12-31 00:00:00'), 0, 'Another test ad.', "平台使用", NOW(), true),
  ...
  (3,NULL, NOW(), 'Test Ad 3', 'https://www.google.com/', NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY), 0, 'Yet another test ad.', "已上架", NOW(), true),
  (1,NULL, NOW(), 'Test Ad 4', 'https://www.google.com/', NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY), 0, 'Test ad number four.', "已上架", NOW(), true),
  (2,NULL, NOW(), 'Test Ad 5', 'https://www.google.com/', NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY), 0, 'The last test ad.', "已上架", NOW(), true),
  ...
  (2,NULL, NOW(), 'Test Ad 8', 'https://www.google.com/', NOW(), DATE('2024-12-31 00:00:00'), 1, 'Sample ad.', "已上架", NOW(), true),
  (3,NULL, NOW(), 'Test Ad 9', 'https://www.google.com/', NOW(), DATE('2024-12-31 00:00:00'), 1, 'Sample ad.', "已上架", NOW(), true),
  (1,NULL, NOW(), 'Test Ad 10', 'https://www.google.com/', NOW(), DATE('2024-12-31 00:00:00'), 1, 'Sample ad.', "已上架", NOW(), true),
...
-- 食品-- 
    (1, NULL, '狗麻吉', 300, 999, '均衡營養, 寵愛狗狗', '已上架', '2023-01-01 10:00:00', 'dog', 4, 2, 0, TRUE),
    (1, NULL, 'Hero 狗', 150, 999, '專為狗狗設計 , 健康零負擔', '已上架', '2023-02-15 14:30:00', 'dog', 5, 3, 0, TRUE),
    (2, NULL, 'Nature 狗飼料', 80, 999, '純天然食品 , 照顧你的小狗', '已上架', '2023-03-20 18:45:00', 'dog', 3, 1, 0, TRUE),
    (2, NULL, 'Good dog', 120, 999, 'S30(鮭魚+甜薯)低過敏配方', '已上架', '2023-04-10 08:00:00', 'dog', 4, 2, 0, TRUE),
    (3, NULL, '狗狗小舖', 200, 999, '在地食材國產非基因改造玉米', '已上架', '2023-05-25 12:00:00', 'dog', 5, 3, 0, TRUE),
    (3, NULL, '七彩鳥 鳥可樂', 200, 999, '特選上等原料，品質純正，含有蛋黃、蛋白質、酵母粉、多種高單位維他命及磷、鈣等礦物質。', '已上架', '2023-05-25 12:00:00', 'bird', 5, 3, 0, TRUE),
    (3, NULL, '雜食鳥營養飼料鳥飼料 八哥/九官鳥專用', 200, 999, '添加天然酵母及複合維他命、鈣、鐵、磷等礦物質，每百公克可產生熱量3860卡，極適合各種雜食性鳥類長期飼用，可促進生長、確保羽毛光澤、活潑健康。', '已上架', '2023-05-25 12:00:00', 'bird', 5, 3, 0, TRUE),
    (3, NULL, '合美健NO.14-B 寵物鳥、鸚鵡用', 200, 999, '精選各類種子，營養配合最均衡。經洗選及乾燥處理，安全無菌，確保衛生健康', '已上架', '2023-05-25 12:00:00', 'bird', 5, 3, 0, TRUE),
    (3, NULL, '凡賽爾 寵物鳥、鸚鵡用 滋養丸', 200, 999, '以大量新鮮水果和穀物為基礎並由科學精算成份比例所組成的顆粒飼料，提供雜食性鳥類所需的營養，完全食用沒有浪費。', '已上架', '2023-05-25 12:00:00', 'bird', 5, 3, 0, TRUE),
    (3, NULL, '愛鳥樂8個蛋黃NO.10/蛋黃栗營養飼料', 200, 999, '精選上等原料，品質新鮮。', '已上架', '2023-05-25 12:00:00', 'bird', 5, 3, 0, TRUE),
    (4, NULL, '博士巧思貓食', 450, 999, '主要使用原料：新鮮海洋魚粉(鮭魚、鯷魚)、雞肉粉、胚芽米', '已上架', '2023-01-01 10:00:00', 'cat', 4, 2, 0, TRUE),
    (4, NULL, '博朗氏貓飼料', 1000, 999, '高適口性平衡糧 產品期限：18個月', '已上架', '2023-01-01 10:00:00', 'cat', 4, 2, 0, TRUE),
    (4, NULL, '保羅叔叔貓飼料', 1300, 999, '運費120元一單限購 2包', '已上架', '2023-01-01 10:00:00', 'cat', 4, 2, 0, TRUE),
    (4, NULL, '博朗氏 貓飼料', 1400, 999, ' LCB藍帶廚坊 -貓飼料 海陸雙拼 (化毛潔牙) 15LB(6.8kg)s', '已上架', '2023-01-01 10:00:00', 'cat', 4, 2, 0, TRUE),
    (5, NULL, '樂倍貓飼料', 1500, 999, ' 樂倍黑酵母無穀保健糧挑嘴貓4.5kg', '已上架', '2023-01-01 10:00:00', 'cat', 4, 2, 0, TRUE) ,

-- 玩具--
  (5, NULL, '超大衝鋒鴨寵物咬咬狗狗玩具', 900, 999, '材質柔軟 不傷牙齒🦷解悶 安心陪伴♥️', '已上架', '2023-01-01 10:00:00', 'dog', 4, 2, 1, TRUE),
  (5, NULL, '繩結 狗玩具', 800, 999, '適合大型犬、大型幼犬、破壞力強', '已上架', '2023-01-01 10:00:00', 'dog', 4, 2, 1, TRUE),
  (5, NULL, '天使法杖×惡魔長鞭 市售最強逗貓棒', 700, 999, '模擬獵物超高速移動🔹 適合愛抓小獵物的貓咪', '已上架', '2023-01-01 10:00:00', 'cat', 4, 2, 1, TRUE),
...
(6, NULL, ' 寵物床 狗窩 寵物涼感床 狗床 貓床 寵物睡窩 寵物涼墊 寵物睡墊 寵物涼感墊', 2500, 999, ' 主子們是沒有毛細孔的 太熱的話容易中暑喔💦炎熱的春夏請幫主子們準備好降溫產品 ', '已上架', '2023-01-01 10:00:00', 'dog', 4, 2, 2, TRUE),
    ...
    (7, NULL, ' 貓窩 寵物窩 四季通用的貓咪窩 貓屋 寵物睡窩 半封閉可拆洗貓床 ', 3500, 999, ' 💞💞可愛的動物耳朵設計，是一張好看的床💞💞用絨球，給你的貓帶來歡樂 ', '已上架', '2023-01-01 10:00:00', 'cat', 4, 2, 2, TRUE),
    (7, NULL, ' 保暖貝殼窩 貓窩 貝殼窩 寵物貝殼窩 寵物窩 貓咪貝殼窩 ', 5000, 999, '🔶觸感舒適柔軟，不易皺摺變形🔶優質PP棉填充，回彈性強不塌陷 ', '已上架', '2023-01-01 10:00:00', 'cat', 4, 2, 2, TRUE),

  -- 美容清潔--
    (7, NULL, '寵物潔足杯 洗腳杯 洗腳器 洗爪器 寵物洗腳 狗狗清潔 ', 1100, 999, '✅柔軟矽膠，不傷腳✅可拆裝設計，方便清洗 ', '已上架', '2023-01-01 10:00:00', 'dog', 5, 2, 3, TRUE),
    (7, NULL, ' 寵物除蚤沐浴乳/敏感肌適用/現貨/你他的招財❤️寵物除蟲清潔液 寵物沐浴 寵物洗澡 寵物用品 狗洗澡  ', 700, 999, '有效去除寵物體外寄生蟲、塵蟎、蟎蟲、跳蚤、蝨子，防止皮膚癢、掉毛、皮膚病變 ', '已上架', '2023-01-01 10:00:00', 'dog', 5, 2, 3, TRUE),
    (8, NULL, ' 寵物沐浴乳 寵物洗毛精 寵物沐浴精 寵物洗澡 狗狗沐浴乳  ', 750, 999, '愛寵是家庭的一員，因此給他們提供最好的護理是非常重要的。全新的寵物沐浴露，適用於狗狗，四季都能使用🧴🫧！', '已上架', '2023-01-01 10:00:00', 'dog', 5, 2, 3, TRUE),
    (8, NULL, ' 送寵物洗毛刷 | 呆丸喵 天然寵物沐浴乳 貓沐浴乳 ', 950, 999, '呆丸喵專為寵物打造的高效除臭的寵物沐浴乳/洗毛精，結合天然植物成分和溫和滋潤配方，有效潔淨並呵護您愛寵的皮膚與毛髮。', '已上架', '2023-01-01 10:00:00', 'cat', 4, 2, 3, TRUE),
    (8, NULL, ' 鳥用體外清潔噴霧 鸚鵡除臭 鸚鵡環境清潔 鳥類通用 除臭噴霧 ', 2300, 999, '未販售應施檢疫物，圖片僅供示意⚠️本產品無任何醫療行為 如有需要請諮詢獸醫師協助', '已上架', '2023-01-01 10:00:00', 'bird', 3, 2, 3, TRUE),
    (8, NULL, ' 潔羽寶 鸚鵡除臭劑 環境清潔 防蟲噴霧 鳥類通用', 450, 999, '適用於: 鸚鵡, 文鳥, 繡眼, 鴿子和其他鳥類日常可以針對環境 鳥籠 巢箱 地面 牆角等定期噴灑', '已上架', '2023-01-01 10:00:00', 'bird', 3, 2, 3, TRUE),


  --  攜帶袋  --
(9, NULL, ' 現貨 貓包外出雙肩包 太空艙寵物包 裝貓背包', 1000, 999, '商品名稱：寵物太空艙背包請注意！！！！首次使用之前請將背包放在空氣流通處、進行通風因為背包是剛出廠、所以可能有味道、非質量問題請進行清理或通風使用背包適用12斤以內寵物台灣現貨、當天下單、一般當天寄出、 ', '已上架', '2023-01-01 10:00:00', 'cat', 5, 2, 4, TRUE),
(9, NULL, ' 大狗背包 寵物背包 寵物包 寵物外出包 寵物後背包 狗狗外出包 狗背包 老狗背帶 狗狗背包', 1100, 999, '🔶LDLC超級工廠出品，適合6公斤內貓、狗、寵物🔶拉鍊升級，更耐用🔶附有同色系肩背帶，可單肩揹、斜肩揹、手提🔶規格 : 約46*26*28cm 適用6公斤以內寵物🔶材質 : 亞麻布+網布+PE板🔶附有行李固定帶🔶全手提包65%為網格設計，透氣不悶熱🔶目前進貨的新出廠手提包都只有單拉鍊頭設計 ', '已上架', '2023-01-01 10:00:00', 'dog', 5, 2, 4, TRUE),
(9, NULL, '貓咪外出包包 貓咪外出雙肩包 貓咪外出背包大容量 貓咪外出袋 寵愛喵包外出便攜包 透氣出行攜帶咪大容量', 1000, 999, '包裹抵達門店會有手機簡訊通知取貨,到貨後請盡快前往便利店完成取貨。 到貨日起算,7天內未完成取貨,您訂購的產品會被退回。 ', '已上架', '2023-01-01 10:00:00', 'cat', 5, 2, 4, TRUE),
(10, NULL, ' 寵物包外出便攜背包大型犬狗狗露頭背包通風透氣可水洗', 1600, 999, '◾ 寵爸寵媽一人外出時，也方便攜帶愛寵◽ 全包露頭露前腳，尊重愛寵隱私，細心呵護寶貝◾ 不管是騎摩托車、重機、腳踏車，可愛寶貝都可以背著陪你出門◽ 耐磨舒適透氣，四季通用，高密度輕微抗水', '已上架', '2023-01-01 10:00:00', 'dog', 4, 2, 4, TRUE),
(10, NULL, ' 批發鳥籠子塑膠組裝寵物籠展示籠25圓形玄鳳牡丹鸚鵡繡眼外出鳥籠', 1500, 999, '材質：高強度工程塑膠 規格：標配：籠體1套+吊鉤1套+底盤1件+站槓1件 顏色：籠體，掛鉤顏色竹黃色', '已上架', '2023-01-01 10:00:00', 'bird', 2, 2, 4, TRUE),
(10, NULL, '  寵尚天鸚鵡外出籠 手提便攜鸚鵡籠子 文鳥虎皮圓形鳥籠觀賞繁殖籠子', 1300, 999, '❤️💛本店所售商品均有品質保證，請放心購買喲 收到貨品後有任何問題請第一時間聯繫我呢 保證給您一個滿意的回復 非常榮幸在成長路上能得到您的支持和鼓勵 喜歡請給我點讚收藏並關注唷 萬分感謝啦💕💕', '已上架', '2023-01-01 10:00:00', 'bird', 2, 2, 4, TRUE),


  --  服飾  --
  (11, NULL, ' 哈利波特寵物聖誕魔法袍斗篷寵物衣服變身裝 眼鏡 領巾領帶貓咪', 500, 999, '您家毛孩子是哪一個學院的呢?哆咔星球tips：領帶S碼脖圍：20-30cm可調節   M碼脖圍：30-40cm可調節   【手工測量誤差1-3cm  請根據您家寶貝的脖圍來選擇哦】   沒有L碼數', '已上架', '2023-01-01 10:00:00', 'cat', 5, 2, 5, TRUE),
 (11, NULL, ' 【貓咪服飾】貓咪狗狗衣服薄款英短藍貓小奶貓防掉毛可愛網紅抖音同款寵物服飾 貓咪衣服', 600, 999, '每一件商品出貨前都會仔細檢查後包裝，希望大家收到商品時都能滿心喜悅的微笑👉產品質量：本店只用上乘 產品質量可靠，放心購買，用的開心', '已上架', '2023-01-01 10:00:00', 'cat', 4, 2, 5, TRUE),
 (11, NULL, ' 狗衣服 秋冬季打底衫 小狗狗衣服', 800, 999, '註意：手工測量，存在2-3厘米誤差，屬於正常，批次不同衣領顏色輕微色差 &nbsp; 商品做升級，下擺位置和袖口不是縮口是圓形下擺', '已上架', '2023-01-01 10:00:00', 'dog', 3, 2, 5, TRUE),
 (11, NULL, ' 夏日防曬狗狗四腳衣/大狗涼感衣服/薄款背心/寵物衣服/狗衣/狗毛衣/', 750, 999, '尺碼偏大一號，請謹慎下單注意：四腳衣先看背長，請購買前一定要測量，不能確定時請購買大一號·，謝謝。【物流資訊】※本商店所有商品出貨時間2-3天，運輸時間5-7天左右到貨，週末、法定節假日物流會有延遲！', '已上架', '2023-01-01 10:00:00', 'dog', 4, 2, 5, TRUE),
(11, NULL, ' 鸚鵡鳥用尿不濕 鸚鵡衣服 鸚鵡尿布 鳥尿布 鳥衣服', 550, 999, '🌟鳥寶尿布衣🌟🌟多款現貨隨時更新🌟以魔鬼氈黏貼，穿的時候可墊衛生紙，或者化妝棉，髒了換掉就好，不用一直洗尿布。🌟鳥寶剛穿一定會不調節，幾次之後就會習慣了', '已上架', '2023-01-01 10:00:00', 'bird', 5, 2, 5, TRUE),

  --  保健食品  --

(11, NULL, ' INPLUS狗保健品 犬用保健 犬用保健食品 益生菌 卵磷脂 關節保健 腸益菌 腸胃保健 關節保健', 1250, 999, '★本產品無任何醫療行為 如有需要請諮詢獸醫師協助★未使用時放置在陰涼處及孩童碰觸不到的地方。', '已上架', '2023-01-01 10:00:00', 'dog', 4, 2, 6, TRUE),
(11, NULL, ' 美國 IN-Plus "贏" 高效能活化益生菌、骨力補-關節心臟強化配方 腸益菌 酵素 整腸 狗狗保健 關節保健', 1150, 999, '【主要成分】：美國專利益生菌PA-5051、活化乳酸菌、果寡糖、甘露聚醣、綜合酵素、綜合維生素、麥芽糊精。【營養成分】：維生素A 300 IU、維生素B1 10.24mg、維生素B2 0.32mg、維生素B3 1.74mg、維生素B5 0.97mg、維生素B6 15.59mg、生物素 6.00μg、葉酸 19.88μg、維生素B12 4.97μg、維生素D3 50IU、維生素E 0.80mg、活性益生菌5x108 cfu、果寡糖10mg、甘露聚糖20mg、綜合消化酵素9mg。', '已上架', '2023-01-01 10:00:00', 'dog', 5, 2, 6, TRUE),
(11, NULL, ' 貓用保健食品系列 貓保健品 貓營養品 營養保健 IN-PLUS贏 皮毛保健 關節保健 眼睛保健 腸胃保', 1450, 999, '🌟發育整腸酵素維護腸胃健康  幫助消化  營養補給/好吸收【主要成份】綜合消化酵素、綜合腸益菌、菊苣根、複合維生素（A、B1、B2、B3、B6、B12、D3、E、生物素、葉酸）、礦物質（鐵、鋅、錳、銅）', '已上架', '2023-01-01 10:00:00', 'cat', 4, 2, 6, TRUE),
(11, NULL, ' 美國 IN-Plus"贏" 貓咪保健專用系列-離胺酸、蔓越莓泌尿安、PA-5051 貓用益生菌 牛磺酸、排毛粉', 1650, 999, '可混和在飼料或罐頭中給予。為保證產品效果，開封後請盡早食用完畢。年齡 6月齡以下 6月齡以上疾病期:一天2次，每次半包 一天2次，每次1包保健期:一天1次，每次半包 一天1次，每次1包', '已上架', '2023-01-01 10:00:00', 'cat', 3, 2, 6, TRUE),

--  配件  --
(1, NULL, ' 優選好物 狗狗自背包大型犬德牧金毛戰術背包外齣自背包寵物牽引狗背包', 600, 999, '本店所售商品均有品質保證，請放心購買，收到貨品後有任何問題請第壹時間聯系我們呢，保證給您壹個滿意的答復！全場商品購滿三件9折~ ', '已上架', '2023-01-01 10:00:00', 'dog', 5, 2, 7, TRUE);
