...
INSERT INTO ad (sellerId,adimg, adImgUploadTime, adName, adStartTime, adEndTime, adLv, adMemo, adStatus, adCreateTime, isEnabled)
VALUES 
  (1,NULL, NOW(), 'Test Ad 1',  NOW(), DATE('2099-12-31 00:00:00'), 1, 'This is a test ad.', "平台使用", NOW(), true),
  (2,NULL, NOW(), 'Test Ad 2',  NOW(), DATE('2099-12-31 00:00:00'), 1, 'Another test ad.', "平台使用", NOW(), true),
  (3,NULL, NOW(), 'Test Ad 3', NOW(), DATE('2099-12-31 00:00:00'), 0, 'Yet another test ad.', "平台使用", NOW(), true),
  (1,NULL, NOW(), 'Test Ad 4', NOW(), DATE('2099-12-31 00:00:00'), 0, 'Test ad number four.', "平台使用", NOW(), true),
  (2,NULL, NOW(), 'Test Ad 5', NOW(), DATE('2024-12-31 00:00:00'), 1, 'The last test ad.', "已上架", NOW(), true),
  (3,NULL, NOW(), 'Test Ad 6', NOW(), DATE('2024-12-31 00:00:00'), 1, 'Sample ad.', "已上架", NOW(), true),
  (1,NULL, NOW(), 'Test Ad 7', NOW(), DATE('2024-12-31 00:00:00'), 1, 'Sample ad.', "已上架", NOW(), true),
  (2,NULL, NOW(), 'Test Ad 8', NOW(), DATE('2024-12-31 00:00:00'), 0, 'Sample ad.', "已上架", NOW(), true),
  (3,NULL, NOW(), 'Test Ad 9', NOW(), DATE('2024-12-31 00:00:00'), 0, 'Sample ad.', "已上架", NOW(), true),
  (1,NULL, NOW(), 'Test Ad 10', NOW(), DATE('2024-12-31 00:00:00'), 0, 'Sample ad.', "已上架", NOW(), true),
  (2,NULL, NOW(), 'Test Ad 11',NOW(), DATE('2024-12-31 00:00:00'), 1, 'Sample ad.', "已上架", NOW(), true);
