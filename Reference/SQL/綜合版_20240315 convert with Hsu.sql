...
VALUES 
    ...
    (1, 'testseller@gmail.com', 'PQR Industries', 'J0123456', 2800000, 'Henry Chang', '0223456789', '345', '0911234567', '新北市', '三峽區', 'XX巷 YY路 10號', '$2a$10$EV92RG7ZPDIqanjqPUfNs.e3/3RZeE2MAwSAmESG2NO/ZL27qfc66', '012345678', '123', '09876543', true);
...
VALUES 
  ...
  ('testbuyer@gmail.com', NULL, 'Buyer10', '0989012345', '0910234567', '1987-05-10', '$10$Vfd9kgtqTcJNogQ2Nwb0auMTBnZ3YP2ghfzAAg7sZq4UaGjYWcuwu', 'Address10', true, '2023-10-01 12:45:00', 'Pet10', NULL, NULL, 'Vaccine19', '2025-04-20 10:00:00', 'Vaccine20', '2025-06-05 13:15:00');
...
VALUES 
  (1,NULL, NOW(), 'Test Ad 1', 'https://www.google.com/', NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY), 1, 'This is a test ad.', "網站使用", NOW(), true),
...
VALUES
    ...
    (2, NULL, '商品D', 120, 40, '這是商品D的描述', '已上架', '2023-04-10 08:00:00', 'dog',4, 2, 4, TRUE),
    (3, NULL, '商品E', 200, 15, '這是商品E的描述', '已上架', '2023-05-25 12:00:00', 'cat',5, 3, 5, TRUE);
-- 優惠券使用  放入測試資料-- 
