...
public class MultiSecurityConfiguration {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
	    ...
	    BuyerAuthenticationFilter buyerAuthenticationFilter = new BuyerAuthenticationFilter(authenticationManager(http), buyerRequestMatcher,buyerSvc,buyerPasswordEncoder,buyeAuthenticationFailureHandler) ;
...
;
			...
			http.formLogin(form -> form.loginPage("/seller/login").permitAll().loginProcessingUrl("/seller/login")
				...
				.exceptionHandling(customizer -> customizer.accessDeniedHandler(customAccessDeniedHandler).authenticationEntryPoint(customAuthenticationEntryPoint)).csrf()
